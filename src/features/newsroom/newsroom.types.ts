...
export type ContentSubscriber = { id: string; userId?: string | null; email: string; displayName?: string | null; status: "ACTIVE" | "UNSUBSCRIBED" | "SUSPENDED"; subscriptionTier: "FREE" | "PREMIUM"; premiumUntil?: string | null; source?: string | null; createdAt: string; updatedAt: string };
