      ...
      <Modal open={open} onClose={() => setOpen(false)} title="Crear grupo contable" description="POST /admin/accounting/account-groups">
        <form className="grid gap-4" onSubmit={onSubmit}>
          ...
          <div className="grid gap-2">
            <Label>Tipo</Label>
            <select name="type" required className="focus-ring h-14 w-full rounded-[14px] border border-slate-500/80 bg-surface-raised px-4 py-3 text-sm shadow-sm hover:border-slate-700 disabled:cursor-not-allowed disabled:opacity-50">
      ...
      <Modal open={open} onClose={() => setOpen(false)} title="Crear cuenta contable" description="POST /admin/accounting/accounts">
        <form className="grid gap-4" onSubmit={onSubmit}>
          <div className="grid gap-2">
            ...
            <select name="groupId" required className="focus-ring h-14 w-full rounded-[14px] border border-slate-500/80 bg-surface-raised px-4 py-3 text-sm shadow-sm hover:border-slate-700 disabled:cursor-not-allowed disabled:opacity-50" disabled={groups.isLoading}>
          ...
          <div className="grid gap-2">
            ...
            <select name="normalBalance" required className="focus-ring h-14 w-full rounded-[14px] border border-slate-500/80 bg-surface-raised px-4 py-3 text-sm shadow-sm hover:border-slate-700 disabled:cursor-not-allowed disabled:opacity-50">
