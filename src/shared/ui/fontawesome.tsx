...
const paths: Record<FaIconName, string[]> = {
  ...
  trash: ["M3.5 6h15", "M8.5 6V4.5A1.5 1.5 0 0 1 10 3h2a1.5 1.5 0 0 1 1.5 1.5V6", "M5.5 6l.8 12a2 2 0 0 0 2 1.9h5.4a2 2 0 0 0 2-1.9L16.5 6", "M9.5 10v6M12.5 10v6"],
  key: ["M13.5 3a5.5 5.5 0 1 1-4.4 8.8L3 18v3h3l1-1v-2h2v-2h2l1.1-1.1A5.5 5.5 0 0 1 13.5 3Z", "M15.5 7.5h.01"],
  "user-pen": ["M9 10.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7Z", "M2.5 20v-1.5A4.5 4.5 0 0 1 7 14h3", "M18.4 12.6l1 1a1.4 1.4 0 0 1 0 2l-4.4 4.4-2.6.5.5-2.6 4.4-4.3a1.4 1.4 0 0 1 2 0Z"],
