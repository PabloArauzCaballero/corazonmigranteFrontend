  ...
  return (
    <div className="grid gap-8">
      ...
      <div className="grid gap-5 md:grid-cols-3">
        <StatCard label="Agenda de hoy" value="0" description="Agenda pendiente de activación." />
        <StatCard label="Solicitudes" value="0" description="Filtrado por terapeuta desde el sistema." />
